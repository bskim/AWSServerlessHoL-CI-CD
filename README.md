...
2. **_Create environment_**버튼을 클릭하여 Cloud9 환경을 생성합니다.
![](images/002_Cloud9_Create_environment.png)
3. Cloud9 이름을 **_NewsWebApp_**이라고 생성합니다. 설명(**_News Web Application using Serverless Service_**은 옵션이기 때문에 넣지 않아도 됩니다.